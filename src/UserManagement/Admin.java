...
public class Admin extends User {
    ...
    public void generateReport(String[] reportParameters) {
        ...
        System.out.printf("%-30s %s%n", "UCMS SUMMARY REPORT", "");
        System.out.println("-".repeat(60));
        System.out.printf("%-30s %s%n", "Total courses:", reportParameters[0]);
        System.out.printf("%-30s %s%n", "Total students:", reportParameters[1]);
        System.out.printf("%-30s %s%n", "Total lecturers:", reportParameters[2]);
        System.out.println("-".repeat(60));
        // display Admin's name
        System.out.printf("%-30s %s%n", "Report generated by:", reportParameters[3]);
        // display date on which the report is generated.
